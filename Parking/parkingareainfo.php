                ...
                <div class="tabbable-line">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab_default_1">
                      ...
                      <p><?php echo $skills; ?></p>
                      -->
                      <h4><strong>Parking Post Date</strong></h4>
                      <p><?php echo $row['drjoin']; ?></p>
                      
                      <h4><strong>Parking ID No</strong></h4>
                      <p><?php echo $row['drnid']; ?></p>
                      
                      <h4><strong>House No</strong></h4>
                      <p><?php echo $row['drlicense']; ?></p>
                      
                      <h4><strong>Parking End Date</strong></h4>
                    ...
                    <div class="tab-pane" id="tab_default_2">
                      ...
                      <a class="btn btn-success" style="text-align: center; margin: 0px 0px -200px;" href="booking.php">See Price List</a>
                    ...
                    <div class="tab-pane" id="tab_default_4">
                      ...
                      <div class="col-sm-10">
                         ...
                         <a class="btn btn-success" style="text-align: center; margin: 0px 0px -200px;" href="booking.php">Book Now</a>
