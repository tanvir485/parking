    ...
    <div class="container">
        ...
        <div class="row">
           <div class="page-header">
            ...
            <div class="col-md-6">
            <p><strong>Name: </strong><?php echo $row['drname']; ?></p>    
                  <p><strong>Post Date: </strong><?php echo $row['drjoin']; ?></p>    
                  <p><strong>ID: </strong><?php echo $row['drnid']; ?></p>    
                  <p><strong>Liences: </strong><?php echo $row['drlicense']; ?></p>    
                  <p><strong>Total Cost: </strong><?php echo $row['drmobile']; ?></p>
