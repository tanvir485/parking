<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $signup_query= "INSERT INTO `userowner`(`first_name`, `last_name`, `email`, `username`, `password`) VALUES ('$firstname','$lastname','$email','$username','$password')"; 
        
        $check_query= "SELECT * FROM `userowner` WHERE username='$username' or email='$email'";
...
<head>
    <meta charset="UTF-8">
    <title>Sign Up Parking Owner</title> 
        ...
        <div class="col-md-6"> 
           <?php echo $msg; ?>
            <div class="page-header">
                <h1 style="text-align: center;">Sign Up As a Parking Owner</h1>      
          </div> 
