        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon"><b>Parking ID No</b></span>
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="bus">Bike</label>
                    </div>
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon"><b>Date of Requirement</b></span>
                      <input id="req_date" type="text" class="form-control" name="req_date" placeholder="" required>
                    ...
                    <div class="input-group">
                      ...
                      <input id="destination" type="text" class="form-control" name="destination" placeholder="Address" required>
                    </div>
                    <br>
                    
                    <div class="input-group">
                      <span class="input-group-addon"><b>Vehicle License</b></span>
                      <input id="pickup" type="text" class="form-control" name="pickup" placeholder="license">
                    </div>
                    <br>
