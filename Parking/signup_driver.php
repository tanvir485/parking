<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $type= mysqli_real_escape_string($connection,strtolower($_POST['type'])); 
        
        
        $signup_query= "INSERT INTO `userdriver`(`first_name`, `last_name`, `email`, `username`, `password`,`type`) VALUES ('$firstname','$lastname','$email','$username','$password','$type')"; 
        
        $check_query= "SELECT * FROM `userdriver` WHERE username='$username' or email='$email'";
        ...
        <div class="col-md-6"> 
           <?php echo $msg; ?>
            <div class="page-header">
                <h1 style="text-align: center;">Sign Up As a Driver</h1>      
          </div> 
            <form class="form-horizontal animated bounce" action="" method="post"> 
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                  <input id="type" type="type" class="form-control" name="type" placeholder="Type it 'driver' ">
                </div>
                <br>
