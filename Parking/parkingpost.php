       ...
       <div class="col-md-3">
        ...
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
                ...
                <div class="input-group">
                  <span class="input-group-addon"><b>Post Date</b></span>
                  <input id="drjoin" type="text" class="form-control" name="drjoin" placeholder="Posting date">
                </div>
                <br>
                ...
                <div class="input-group">
                  <span class="input-group-addon"><b>House No</b></span>
                  <input id="drlicense" type="text" class="form-control" name="drlicense" placeholder="House No">
                </div>
                <br>
                
                 <div class="input-group">
                  <span class="input-group-addon"><b>Parking End Date</b></span>
                ...
                <br>
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>Owner Address</b></span>
